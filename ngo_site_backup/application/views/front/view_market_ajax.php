				...
				<div class = "thumbnail">
					...
					<div class = "caption">
						...
						<p>
							...
							<a href="<?php echo base_url('market/view_details?id='.base64_encode(base64_encode($data['id'])))?>" title="View Details" class = "btn btn-info btn-sm pull-right" role = "button">
								View Details
							</a>
							</span>
						</p>
