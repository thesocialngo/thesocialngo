<div class="container-fluid">
	<div class="row" style="margin: 0px;">
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 nopadding" style=" background-image: url(images/humunity_bazar.png); height:149px;  background-size: cover;
...
<div class="container">
			...
			<div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
				<p><b>Togther!!!</b><a href="#"> We can make differnce</a></p>
					<button class="btn btn-success" data-toggle="modal" data-target="#myModal">Upload & donate</button>
...
?>
					...
					<input type="hidden" id="url" value="donate_distnict/display_donate_item">
